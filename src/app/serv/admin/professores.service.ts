...
export class ProfessoresService {
  private apiUrl = 'https://api.piatividade24.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.piatividade24.duckdns.org/courses'; // Caso precise acessar cursos também
