...
export class CcursoService {
  private apiUrl = 'https://api.piatividade24.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.piatividade24.duckdns.org/subject/';  // URL para buscar as disciplinas
