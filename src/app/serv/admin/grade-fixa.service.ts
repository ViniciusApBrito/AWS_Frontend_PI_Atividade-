...
export class GradeFixaService {
  private apiUrl = 'https://api.piatividade24.duckdns.org/reservation/';
  private teachersUrl = 'https://api.piatividade24.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.piatividade24.duckdns.org/subject/';
  private timesUrl = 'https://api.piatividade24.duckdns.org/time/';
  private roomsUrl = 'https://api.piatividade24.duckdns.org/rooms/';
  private coursesUrl = 'https://api.piatividade24.duckdns.org/course/';
